...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, GRAY_SCL_Pin|GRAY_SDA_Pin|LED_2_Pin|LED_1_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, GRAY_KEY_Pin|OLED_SDA_Pin|OLED_SCL_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, GRAY_KEYD15_Pin|LED_4_Pin|LED_3_Pin, GPIO_PIN_SET);
  ...
  GPIO_InitStruct.Pin = GRAY_KEY_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GRAY_KEY_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : GRAY_KEYD15_Pin */
  GPIO_InitStruct.Pin = GRAY_KEYD15_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(GRAY_KEYD15_GPIO_Port, &GPIO_InitStruct);
